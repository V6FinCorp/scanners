...
def run_scanner():
    ...
    try:
        ...
        kwargs = {
            ...
            'fastLength': data.get('fastLength', 12),
            'slowLength': data.get('slowLength', 26),
            'signalLength': data.get('signalLength', 9),
            'oscillatorMAType': data.get('oscillatorMAType', 'EMA'),
            'signalMAType': data.get('signalMAType', 'EMA')
        }
