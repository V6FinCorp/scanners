"""
COALINDIA Stock Analysis - EMA 9/15 Crossover Strategy
...
class COALINDIAAnalyzer:
    """Main analyzer class for COALINDIA EMA strategy backtesting"""
    
    def __init__(self):
        self.data_path = r"E:\Mark\V6\code_zone\vs_ws_pycode\fetch_historical\historical_data\COALINDIA\COALINDIA_5_combined.csv"
        self.results = {}
        self.raw_data = None
        ...
        print("🔥 COALINDIA EMA Crossover Strategy Analysis")
        print("=" * 50)
    ...
    def load_data(self) -> pd.DataFrame:
        """Load and prepare COALINDIA data"""
        print("📊 Loading COALINDIA data...")
    ...
    def run_comprehensive_analysis(self):
        ...
        print("\n🚀 Starting Comprehensive COALINDIA Analysis...")
        print("=" * 60)
            ...
            for risk_ratio in self.risk_ratios:
                for stop_type in self.stop_types:
                    ...
                    if result:
                        ...
                        print(f"   ✅ Return: {result['backtest_result']['Return [%]']:.2f}%, Trades: {result['backtest_result']['# Trades']}")
...
def main():
    """Main function to run COALINDIA analysis"""
    # Create analyzer instance
    analyzer = COALINDIAAnalyzer()
